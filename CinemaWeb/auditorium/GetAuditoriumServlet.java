...
/**
 * Servlet implementation class GetAuditorium
 */
@WebServlet("/GetAuditorium")
public class GetAuditoriumServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try {
            ...
            request.getRequestDispatcher("/WEB-INF/auditoriums/auditoriumEdit.jsp").forward(request, response);
