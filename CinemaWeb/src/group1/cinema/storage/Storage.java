...
public final class Storage {
    ...
    public Storage() throws ClassNotFoundException, SQLException{
        if (this.conn==null){
            ...
            System.out.println("Skapa db connection..");
        }    
    }
    // Slut
    ...
    /**
     * Deletes an screening from the storage
     *
     * @param id Screening ID
     * @return True if the screening was found and successfully removed, otherwise false
     * @throws SQLSyntaxErrorException SQL Syntax Error
     * @throws SQLException SQL Error
     */
    ...
    {
	// SQL Query
	String sql = "CALL `deleteScreening`(?);";
    ...
    /**
     * Deletes an movie from the storage
     *
     * @param id Movie ID
     * @return True if the movie was found and successfully removed, otherwise false
     * @throws SQLSyntaxErrorException SQL Syntax Error
     * @throws SQLException SQL Error
     */
